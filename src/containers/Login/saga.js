...
export default function* dataShowcases() {
  ...
  yield takeLatest(actions.getCountries.TRIGGER, getCountriesRequest);
  yield takeLatest(actions.getPhoneAllow.TRIGGER, getListPhoneAllowRequest);
  yield takeLatest(actions.getCurrentHousing.TRIGGER, getCurrentHousingRequest);
  yield takeLatest(actions.getSubProduct.TRIGGER, getSubProductRequest);
  yield takeLatest(actions.getSelectionNew.TRIGGER, getSelectionsNewRequest);
  // @saga3
}
